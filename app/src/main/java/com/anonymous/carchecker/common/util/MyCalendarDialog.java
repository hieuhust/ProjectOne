...
public class MyCalendarDialog extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        mDataReturnListener.onDataReturn(view, year, month, dayOfMonth);
    }

    public static interface DataReturnListener {
        void onDataReturn(DatePicker view, int year, int month, int dayOfMonth);
    }
}
